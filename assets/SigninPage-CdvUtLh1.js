import{r as d,b as V,u as Z,j as e,a as R,L as v,X as ee}from"./index-n27l2F3d.js";import{a as E,u as q}from"./index-8ldvlUj0.js";import{m as o}from"./proxy-BUbh2NQC.js";import{A as X}from"./arrow-left-rfVC0Yr0.js";import{A as y}from"./index-CXAV43qB.js";import{C as z}from"./circle-check-big-bD7xAjnU.js";import{M as A}from"./mail-BJbKGF2k.js";import{L as Y}from"./lock-GDmAgugg.js";import{E as G}from"./eye-off-Df4J6AOs.js";import{E as H}from"./eye-CydQj_0e.js";import{A as O}from"./arrow-right-KFjpRZ01.js";const k=({icon:c,label:M,hint:p,error:x,children:h,optional:g})=>e.jsxs("div",{children:[e.jsxs("div",{className:"flex items-center justify-between mb-1.5",children:[e.jsx("label",{className:"text-sm font-medium lg:text-gray-700 text-gray-300",children:M}),g&&e.jsx("span",{className:"text-xs text-gray-400",children:"Optional"})]}),e.jsxs("div",{className:"relative",children:[e.jsx("div",{className:"absolute z-10 inset-y-0 left-3 flex items-center pointer-events-none",children:e.jsx(c,{className:"w-5 h-5 lg:text-gray-400 text-gray-300"})}),h]}),p&&!x&&e.jsx("p",{className:"mt-1.5 text-xs text-gray-400",children:p}),x&&e.jsx("p",{className:"mt-1.5 text-xs text-red-400",children:x})]}),xe=()=>{const[c,M]=d.useState({email:"",password:""}),[p,x]=d.useState(""),[h,g]=d.useState(""),[j,$]=d.useState(!1),[f,D]=d.useState(!1),[W,_]=d.useState(!1),[w,F]=d.useState(""),[J,B]=d.useState(!1),[P,S]=d.useState(!1),[I,b]=d.useState(""),{login:K}=V(),Q=Z();d.useEffect(()=>{const a=document.getElementById("login-stars-container");if(a){for(let s=0;s<150;s++){const t=document.createElement("div");t.className="star";const n=Math.random()*100,l=Math.random()*100,i=Math.random()*2.5+.5,r=Math.random()*4+2,u=Math.random()*5,m=Math.random()*.7+.3;t.style.cssText=`
        position: absolute;
        left: ${n}%;
        top: ${l}%;
        width: ${i}px;
